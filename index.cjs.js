...
function compiler(markdown, options) {
    ...
    function h(tag, props) {
        ...
        return _react2.default.createElement.apply(_react2.default, [get(options.overrides, tag + '.component', tag), _extends({}, overrideProps, props, {
    ...
    var arr = emitter(parser(inline ? markdown : markdown.replace(TRIM_NEWLINES_R, '') + '\n\n', { inline: inline }));
